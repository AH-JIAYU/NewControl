...
<template>
  <div v-loading="loading">
    <ElForm ref="formRef" :model="form" :rules="formRules" label-width="120px" label-suffix="：">
      ...
      <ElFormItem v-if="type.registerType === 'phone'" label="手机号码" prop="phone">
        <ElInput v-model="form.phone" placeholder="请输入手机号码" />
      </ElFormItem>
      <ElFormItem v-if="type.registerType === 'email'" label="电子邮箱" prop="email">
      ...
      <ElFormItem label="版本分配" prop="version">
        <el-select v-model="form.version" :disabled="type.id" placeholder="请选择版本">

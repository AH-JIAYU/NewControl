...
<template>
  <div class="absolute-container">
    ...
    <div class="page-main">
      <LayoutContainer hide-left-side-toggle>
        <template #leftSide>
          ...
          <ElScrollbar class="tree">
            <ElTree
              ref="dictionaryRef" :data="dictionary.tree" :filter-node-method="dictionaryFilter as any"
        ...
        <div v-show="dictionaryItem.search.dictionaryId" class="dictionary-container">
          ...
          >
            ...
            <ElTableColumn label="状态" width="100" align="center">
              <template #default="scope">
                <ElSwitch
                  v-model="scope.row.enable" :loading="scope.row.enableLoading" inline-prompt active-text="启用"
      ...
      <DictionaryDialog
        v-if="dictionary.dialog.visible" :id="dictionary.dialog.id" v-model="dictionary.dialog.visible"
